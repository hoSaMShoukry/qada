...
import chatBusiness from '@/modules/Business/pages/chatBusiness.vue'
...
import projectRequestsVue from "@/modules/Admin/pages/projectRequests.vue";
import PendingProjects from "../modules/Admin/pages/PendingProjects.vue"
import adminFaqVue from "@/modules/Admin/pages/adminFaq.vue";
import adminTermsVue from "@/modules/Admin/pages/adminTerms.vue";
...
import officePanelVue from "@/modules/Engineering_offices/Pages/officePanel.vue";
  ...
  // admin routes
  {
    ...
    children: [
      ...
      },
      {
        ...
        component:projectRequestsVue
      },
      {
        path:'/adminTerms',
        name:'adminTerms',
        component:adminTermsVue
      },
      {
        path:'/adminQuestiosn',
        name:'adminQuestions',
        component:adminFaqVue
      },
      {

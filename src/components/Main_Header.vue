    ...
    <nav class="navbar navbar-expand-lg ">
      <div class="container-fluid ">
        ...
        <div  class="text-end d-flex responsive-header"  v-if="x.matches" style="direction:rtl;flex-wrap: wrap;">
            <button v-if="x.matches" :class="auth != '' ? 'd-none' : ''" @click="router.push('/loginPanal')" type="button" class="btn ms-2 mt-2  login">تسجيل الدخول</button>
...
<rect width="30" height="30" fill="white"/>
  ...
  <!--rejected projects-->
  <div class="rejected-projects d-flex mt-1" type="button" data-toggle="modal" data-target="#exampleModal" v-for="project in getAllProjects.rejected" :key="project" @click="refuseReasone(project)">
...
<!--end accepted projects-->
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent" style="z-index: 999;">
          <ul class="navbar-nav ms-auto mb-2 mb-lg-0 align-items-lg-baseline ">
            ...
            <li class="nav-item mx-lg-2">
              <router-link :class="$route.fullPath == '/member' || $route.fullPath == '/' ? 'nav-link ra2esia' : 'nav-link'" to="/member"> الرئيسية</router-link>
            </li>
            <li class="nav-item mx-lg-2">
            ...
            <button v-if="!x.matches" :class="auth != '' ? 'd-none' : ''" @click="router.push('/loginPanal')" type="button" class="btn ms-2   login">تسجيل الدخول</button>
 ...
 <div class="dropdown" v-if="auth">
  ...
  <div 
  v-motion-fade-visible
  style="width: 310px;transition: 0.5s; height:360px; background-color: #0b5a08;padding-right: 10px;" class="dropdown-menu notify-menu" aria-labelledby="dropdownMenuButton">
  <div v-for="project in getAllProjects.accepted" :key="project" class="accepted d-flex mt-1" >
    <div class="svg ms-2" v-if="getAllProjects.accepted.length > 0">
      <svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
<g clip-path="url(#clip0_344_8289)">

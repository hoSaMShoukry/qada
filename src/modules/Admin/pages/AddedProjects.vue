<template>
    <div class="row added-projects">
        <div class="col-lg-12">
            <div class=" mb-5 d-flex">
                <div class="me-5 tab" @click="showComponent = 'last_projects'">
                    <span class="fs-4" >اخر المشاريع المضافة علي المنصة</span>
                </div>
                <div class="me-5 tab" @click="showComponent = 'project_requests'">
                    <span class="fs-4">طلبات المشاريع</span>
                </div>
            </div>
            <!--
                  <div class="d-flex justify-content-between text-center">
                    <div class="col-3">
                        <p>صورة صك الملكية</p>
                        <img :src="'https://test.m-aboelela.online/api/projects/' + project.id + '/' + project.title_deed"
                            alt="صك الملكية" class="w-75 titel_deed">
                    </div>
                    <div class="col-3">
                        <p>صورة من هوية المالك</p>
                        <img :src="'https://test.m-aboelela.online/api/projects/' + project.id + '/' + project.owner_id"
                            alt="هوية المالك" class="w-75 titel_deed">
                    </div>
                    <div class="col-3">
                        <p>مستندات اخري</p>
                        <img :src="'https://test.m-aboelela.online/api/projects/' + project.id + '/' + project.other_files"
                            alt="مستندات اخري" class="w-75 titel_deed">
                    </div>
                </div>
            -->
        ...
        <div class="w-100 text-center">
          <span class="d-inline-block">
            ...
            <ProjectRequests v-if="showComponent == 'project_requests'"/>
            <div  v-for="project in allProjects " :key="project.id" class="w-100 card-link pb-5"
        v-motion-slide-right
        style="transition: 0.5s;"
        >
           <div class="row justify-content-center my-3 text-decoration-none"  v-if=" showComponent == 'last_projects'">
...
<svg xmlns="http://www.w3.org/2000/svg" width="30" height="29" viewBox="0 0 30 29" fill="none">
                ...
                <div class="row">
                    ...
                    <div class="col-xl-3 col-lg-3 col-md-3 col-sm-6 col-12">
                        <p class="d-block">صورة صك الملكية</p>
                        <img :src="'https://test.m-aboelela.online/api/projects/' + project.id + '/' + project.title_deed"
                            alt="صك الملكية" class="w-75 titel_deed">
                    </div>
                    <div class="col-xl-3 col-lg-3 col-md-3 col-sm-6 col-12">
                        <p class="d-block">صورة من هوية المالك</p>
                        <img :src="'https://test.m-aboelela.online/api/projects/' + project.id + '/' + project.owner_id"
                            alt="هوية المالك" class="w-75 titel_deed">
                    </div>
                    <div class="col-xl-3 col-lg-3 col-md-3 col-sm-6 col-12">
                        <p class="d-block">مستندات اخري</p>
                        <img :src="'https://test.m-aboelela.online/api/projects/' + project.id + '/' + project.other_files"
                            alt="مستندات اخري" class="w-75 titel_deed">
                    </div>
                </div>
...
import ProjectRequests from "./projectRequests.vue"
import { addData } from "@/stores/addData"
export default {
    setup() {
        const allProjects = ref([]);
        const getData = addData();
        const showComponent = ref('last_projects')
        const getAllProjects = async () => {
            await axios.get('https://test.m-aboelela.online/api/admin/projects/index', {
                headers: {
        ...
        const filteredProjects = computed(() => {
            return projects.value.filter(project => project.state === 0);
        });
        onMounted(() => {
    ...
    components: { ProjectRequests ,IntersectingCirclesSpinner}
}
</script>

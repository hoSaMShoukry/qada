        ...
        <div class="col-lg-10  ">
            <div class=" mb-3">
                <ul class="d-flex ">
                    ...
                    <li class=""><router-link to="/admin/projectRequests" class="tab mx-5">طلبات
                            المشاريع</router-link></li>
                </ul>
            </div>
            <div v-for="project in  allProjects " :key="project.id" class="col-lg-8 m-auto mb-3 p-1 card">
                <!-- <p>{{ result.data}}</p> -->
                <div class="">
                    <div class="">
                    ...
                    <div class="d-flex mb-4">
                        ...
                        <div class="col-md-3 col-sm-12 ">
                            ...
                            <div>
                                <!--
<span class="subContent">{{ Object.values(JSON.parse(project.electronic_service))[0]
                                }}</span>
                                -->

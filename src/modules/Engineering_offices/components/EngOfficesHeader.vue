...
<li class="nav-item mx-lg-2">
            ...
            <li class="nav-item mx-lg-2">
              <router-link to="/EngineeringOffices/faq" :class="$route.fullPath == '/EngineeringOffices/faq' ? 'nav-link ra2esia' : 'nav-link'">الاسئلة المتكررة</router-link>
            </li>
            <li class="nav-item mx-lg-2">
              <router-link to="/EngineeringOffices/termsandconditions" :class="$route.fullPath == '/EngineeringOffices/termsandconditions' ? 'nav-link ra2esia' : 'nav-link'">الشروط والاحكام</router-link>
            </li>
            <li class="nav-item mx-lg-2">
              <router-link to="/EngineeringOffices/successPartners" :class="$route.fullPath == '/EngineeringOffices/successPartners' ? 'nav-link ra2esia' : 'nav-link'">المكاتب الهندسية </router-link>
            </li>
            <li class="nav-item mx-lg-2">

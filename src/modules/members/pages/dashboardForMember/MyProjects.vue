<template>
   <div class="loading w-100" v-if="projects.allProjects.length == 0">
    ...
    <div class="d-flex align-items-start">
        ...
        <div class="header my-4" v-if="projects.allProjects > 0">مشاريعي</div>
...
const projects = getAllProjctsForOne();
const getData = addData();
onUnmounted(() => {
  projects.allProjects = [];
});
onMounted(() => {
    projects.getprojects('https://test.m-aboelela.online/api/welcome');
});
</script>
<style scoped>
*{

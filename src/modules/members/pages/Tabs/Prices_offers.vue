<template>
    ...
    <div class="row justify-content-between  p-3 m-auto my-3 cardd">
        ...
        <div class="row justify-content-between text-center " >
            <div class="col-lg-4">
                <button @click="contract_offer.contractNewOffer('https://test.m-aboelela.online/api/user/contracts/create' , project_id , offerId)" type="button" class="btnn btn mt-3">تعاقد الأن</button>
            </div>
            <div class="col-lg-4">

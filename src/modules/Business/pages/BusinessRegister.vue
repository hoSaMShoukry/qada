    ...
    <div class="container">
        ...
        <form @submit.prevent="register()" class="w-75 m-auto">
            ...
            <div class="text-danger" v-if="sendRegisterData.registerd"><span>{{ sendRegisterData.registerd }}</span></div>
                        -->
            <button @click.prevent="sendRegisterData.registerBuisnessApi() , v$.$validate()" class="btn btn-primary mt-3">
        ...
        <div class="my-5 text-center">
            ...
            <p class="p2 "> <router-link to="/business/Login"> سجل دخولك من هنا </router-link> </p>
        </div>
    </div>
</template>

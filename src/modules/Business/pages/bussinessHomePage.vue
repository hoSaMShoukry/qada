...
<div class="row justify-content-center my-3">
    ...
    name: 'maintabsForBussiness', params: { id: project.id }
-->
<!--loading-->
...
<div v-for="project in filter.lastFilterd" :key="project.id" @click="setproject(project)" class="card-link" style="cursor: pointer;">
...
const setproject = (project)=>{
      ...
      router.push({name: 'maintabsForBussiness', params: { id: project.id }
})
    }
const allProjects = ref([]);
const setProjectId = (project)=> {
  localStorage.setItem('p-Id' ,project.id)
